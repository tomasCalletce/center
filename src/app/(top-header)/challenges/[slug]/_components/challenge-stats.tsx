...
export const ChallengeStats: React.FC<ChallengeStatsProps> = ({ slug }) => {
  ...
  const { total_submissions, recent_submissions, total_participants } = statsQuery.data;
  ...
  return (
    <div className="p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-bold text-white">{total_submissions}</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-bold text-white">{total_participants}</div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-bold text-white">{recent_submissions}</div>
